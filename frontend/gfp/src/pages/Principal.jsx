...
export default function Principal(){
    ...
    return(
        <div className="flex h-screen font-sans bg-gradient-to-b from-[#2c3e50] to-[#3498db]">
            {/* div para fechar menu clicando fora */}
            <div className={`fixed inset-0 bg-blue-900 bg-opacity-80 z-30 md:hidden
             ...
             `}>
                ...
                <nav className="flex-1">
                    <div className="px-4 lg:px-6 mb-2 ">
                        ...
                        <MdGridView className="w-8 h-9"/>
                        <span className="font-semibold md:hidden lg:block">Dashbord</span>
                        </Link>
                    </div>
                    <div className="px-4 lg:px-6 mb-2 ">
                        ...
                        <MdCached className="w-8 h-9"/>
                        <span className="font-semibold md:hidden lg:block">Transações</span>
                        </Link>
                    </div>
                    <div className="px-4 lg:px-6 mb-2 ">
                        ...
                        <MdCreditCard className="w-8 h-9"/>
                        <span className="font-semibold md:hidden lg:block">Contas</span>
                        </Link>
                    </div>
                    <div className="px-4 lg:px-6 mb-2 ">
                        ...
                        <MdOutlineLocalOffer className="w-8 h-9"/>
                        <span className="font-semibold md:hidden lg:block">Categorias</span>
                        </Link>
                    </div>
                </nav>
                <div className="p lg:p-6 border-t border-slate-700 bg-cyan-600 hover:bg-cyan-700
                 text-white font-bold py-1 px-4 rounded-lg m-4">
