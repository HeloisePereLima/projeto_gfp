import { MdAccountBalance, MdDirectionsCar, MdSchool, MdSportsSoccer, MdShoppingCart, MdPets, MdFavorite, MdFitnessCenter, MdWallet, Md4K, MdRestaurant } from "react-icons/md";
...
export const iconesCategoria = {
        ...
        "home": <MdAccountBalance className="w-6 h-6"/>,
